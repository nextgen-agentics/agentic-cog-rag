...
LIMITS = {
    ...
    # WandB Inference — concurrency-based (2000 concurrent/user), no hard RPM/RPD.
    # We use generous bookkeeping limits with a short cooldown to avoid thrashing.
    "wandb":      {"rpm": 60,   "rpd": 9999,    "tpm": 200000,   "cooldown": 1,   "max_ctx": 128000},
}
...
DEFAULT_ROUTER_ORDER = ["cerebras", "groq", "nvidia", "wandb","github"]
